...
class TestAccountPage:
    ...
    def test_get_profile_page_by_button_success(
            self,
            driver,
        ...
        account_page.get_site_as_login_user(email, password)
    ...
    def test_move_to_order_history_page(
            self,
            driver,
            email=Constant.TEST_EMAIL,
            password=Constant.TEST_PASSWORD
